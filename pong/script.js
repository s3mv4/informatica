...
function ballMovement() {
    ...
    if (ball.x + ball.xvelocity <= (paddle1.x + paddle1.width) &&
        ball.y + ball.yvelocity <= (paddle1.y + paddle1.height) &&
        (ball.x + ball.size) + ball.xvelocity >= paddle1.x &&
        (ball.y + ball.size) + ball.yvelocity >= paddle1.y) {
        ball.xvelocity *= -1
    }

    if (ball.x + ball.xvelocity <= (paddle2.x + paddle2.width) &&
        ball.y + ball.yvelocity <= (paddle2.y + paddle2.height) &&
